...
<x-app-layout>
  ...
  <table class="dashboard__main__content__users">
    <tr class="dashboard__main__content__users__headers">
      ...
      <th class="dashboard__main__content__users__headers__header">Apellido</th>
      ...
      <th class="dashboard__main__content__users__headers__header">Fecha de nacimiento</th>
              <th class="dashboard__main__content__users__headers__header">Action</th>
  ...
  @if(count($admin) > 0)
    ...
    <tr class="dashboard__main__content__users__row">
      ...
      <td class="dashboard__main__content__users__row__data">{{ $administrador->apellido }}</td>
      <td class="dashboard__main__content__users__row__data">{{ $administrador->usuario->email }}</td>


      <td class="dashboard__main__content__users__row__data">{{ $administrador->usuario->cedula}}</td>
      <td class="dashboard__main__content__users__row__data">{{ $administrador->fecha_nacimiento }}</td>
  ...
  <a  href="{{ route('administradores.create') }}" class="dashboard__main__content__add-user-btn">
  ...
  <div class="dashboard__main__content__user-stats">
    <div class="dashboard__main__content__user-stats__total">
      ...
      <span class="dashboard__main__content__user-stats__total__value">
